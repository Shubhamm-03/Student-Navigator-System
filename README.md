...
| Dashboard | Today's Classes | Weekly Timetable |
|-----------|-----------------|------------------|
| Dashboard Screenshot | Today Screenshot | Week Screenshot |
...
- 🔐 Secure Student Login (JWT Authentication)
